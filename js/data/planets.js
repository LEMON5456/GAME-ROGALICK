  ...
  planets: [
    ...
    },
    {
      ...
      waves: [
        ...
        { delay: 40, enemies: [{type:'orc', count:1}, {type:'spitter', count:2}, {type:'crawler', count:2}] },
...
export const SECTOR_3 = {
  ...
  planets: [
    ...
    },
    {
      ...
      waves: [
        { delay: 10, enemies: [{type:'crawler', count:3}, {type:'orc', count:1}, {type:'spitter', count:2}] },
        { delay: 30, enemies: [{type:'flyer', count:2}, {type:'kamikaze', count:2}, {type:'orc', count:1}] },
        { delay: 55, enemies: [{type:'orc', count:2}, {type:'spitter', count:2}, {type:'flyer', count:2}] },
      ],
    },
  ],
};
